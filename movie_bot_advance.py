...
TOKEN = "7348893495:AAEyPcdCEhgZPI8FmKNBlgAQjMVj-na0fhA"  # अपना बॉट टोकन डालें
MOVIE_DB = "movies.json"
ADMIN_ID = 6221923358  # अपना टेलीग्राम ID सेट करें
CHANNEL_ID = ["@movie_realised","@new_realise_movie_2025","@LatestUpdate_bot","@Thara_Box_bot"]  # अपना चैनल ID सेट करें
...
async def add_movies(update: Update, context):
    ...
    if added_movies:
        ...
        # ✅ Notify Users
        notification_text = "🎥 *New Movies Added!• @LatestUpdate_bot , @Thara_Box_bot •*\n\n" + "\n".join([f"🎬 {m}" for m in added_movies])
